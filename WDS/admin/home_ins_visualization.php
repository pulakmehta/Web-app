...
<html lang="en">
    <head>
        <?php 
            $sql_amount_by_cust = "
            SELECT 
              c.cust_id, c.email,sum(hp.amount) as homett FROM cust_details c JOIN home_ins h ON h.cust_id=c.cust_id JOIN home_ins_payments hp ON hp.hinsid=h.hinsid WHERE hp.status='1' AND hp.hinsid=h.hinsid GROUP BY c.cust_id
            ";
        ...
        <title>Admin Page</title>
            ...
            <script type="text/javascript">
              ...
              function drawAmountChart() {
                ...
                var options = {
                  title: 'Amount Spent on Home Insurance By each customer'
                };
            ...
            <div id="layoutSidenav_content">
                <main>
                      ...
                      <div class="home_ins_content">
                        ...
                        <h1 class="mt-4">Home Insurance Dashboard</h1>
                            ...
                            <div class="card-body">
                                <div class="col-xl-12">
                                            ...
                                            <li class="list-group-item">
                                                ...
                                                <?php 
                                                        $query = "SELECT SUM(amount) AS tsum FROM home_ins_payments WHERE status='1'"; 
                                            ...
                                            <li class="list-group-item">
                                                <?php 
                                                        $query1 = "SELECT * FROM home_ins";
                                                        $query2 = "SELECT * FROM home_ins WHERE STATUS = 'C'";  
                                                        $num = mysqli_query($conn, $query1);
                                                        $cur = mysqli_query($conn, $query2);
                                                        if ($num) 
                                                        {   
                                                            $sum = mysqli_num_rows($num);
                                                            printf("Total number of users who have used home insurance product is <b> %d</b>\n",$sum);  
                                                            printf ("<br>");
                                                            printf ("&nbsp; &nbsp;");
                                                            $sum2 = mysqli_num_rows($cur);
                                                            printf("- Total number of current users of the home insurance is <b> %d</b>\n",$sum2);
                                                            printf ("<br>");
                                                            printf ("&nbsp; &nbsp;");  
                                                            $sum3 = mysqli_num_rows($num) - mysqli_num_rows($cur);
                                                            printf("- Total number of past users of the home insurance is <b> %d</b>\n",$sum3);
                                                        }
                                                ?>
                                                <div class="row">
